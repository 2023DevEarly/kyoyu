...
<html>
    ...
    <body>
        ...
        <div class="back1">
            ...
            <a href="http://localhost/chanel/kanri.php">管理者はこちらから</a>
    ...
    <div style="text-align:right">
        <a href='http://localhost/chanel/createthread.php'  style=" width: 65px;height: 65px;" >⊕</a>
        </div>
</html>